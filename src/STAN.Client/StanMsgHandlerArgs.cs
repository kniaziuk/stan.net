...
namespace STAN.Client
{
    ...
    public class StanMsgHandlerArgs : EventArgs
    {
        ...
        /// <param name="redeliveryCount">Redelivery count of the message.</param>
        ...
        public StanMsgHandlerArgs(byte[] data, bool redelivered, uint redeliveryCount, string subject, long timestamp, ulong sequence, IStanSubscription subscription)
        {
            msg = new StanMsg(data, redelivered, redeliveryCount, subject, timestamp, sequence, subscription);
        }
